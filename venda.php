...
while ($linha = $consulta->fetch(PDO::FETCH_ASSOC)) {
    ...
    <td><a href='acao_venda.php?acao_venda=editar&v_id_Venda=<?php echo $linha['v_idVenda'];?>'>editar</a></td>
    <td><a href="javascript:excluirRegistro('acao_venda.php?acao_venda=excluir&v_idVenda=<?php echo $linha['v_idVenda'];?>')">xxxx</a></td>
</tr>
